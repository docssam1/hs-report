...
window.GFIELD_DATA = {
  ...
  "students": [
    "허유민", "김현우", "김유준", "김소이", "이하린", "정지안", "안채연", "박서진", "민준기", "김서연", "김명서", "임유준"
  ],
  "attendance": {
    "허유민": [],
    "김현우": ["may-w34","jun-w12","jun-w3","jun-w4"],
    "김유준": ["may-w34","jun-w12","jun-w3","jun-w4"],
    "김소이": ["may-w34","jun-w12","jun-w3"],
    "이하린": ["may-w34","jun-w12","jun-w3","jun-w4"],
    "정지안": [],
    "안채연": ["may-w34","jun-w12","jun-w3","jun-w4"],
    "박서진": ["may-w34","jun-w12","jun-w3","jun-w4"],
    "민준기": ["may-w34","jun-w12","jun-w3","jun-w4"],
    "김서연": ["may-w34","jun-w12","jun-w3","jun-w4"],
    "김명서": ["may-w34","jun-w12","jun-w3","jun-w4"],
    "임유준": ["may-w34","jun-w12","jun-w3","jun-w4"]
  },
  "specialStudents": [],
  ...
  "vip": {
    ...
    "magazine": [
      { "category": "학원가", "title": "대치동 대형학원 '승자독식' 심화…시대인재 개설 반 3.9배 증가", "desc": "학령인구 감소 속에서도 대치동 대형 입시학원의 규모는 오히려 커지고 있다. 시대인재를 운영하는 하이컨시의 대치동 개설 반 수는 2022년 3453개에서 지난해 1만3345개로 3.9배 늘었다. 중소학원 붕괴와 대형학원 프리미엄화가 동시에 진행되는 양상이다.", "source": "머니투데이", "sourceUrl": "https://www.mt.co.kr/amp/policy/2026/05/27/2026052711123823721", "image": "", "date": "2026-07-01" },
      { "category": "입시", "title": "2028 대입 개편 확정…통합형 수능·내신 5등급 체제 도입", "desc": "2028학년도부터 선택과목 없는 통합형 수능이 도입되고, 고교 내신은 기존 9등급에서 5등급 체제로 개편된다. 현재 중학생 학부모라면 과목 선택 전략보다 기본 개념의 폭넓은 이해가 더 중요해지는 변화다.", "source": "교육부 행복한교육", "sourceUrl": "https://happyedu.moe.go.kr/happy/bbs/selectHappyArticle.do?bbsId=BBSMSTR_000000005240&nttId=38915", "image": "", "date": "2026-07-01" },
      { "category": "교육정책", "title": "유아 무상교육·보육 지원 대상 4세까지 확대", "desc": "2026년부터 유아 무상교육·보육비 지원 대상이 4세까지 확대됐다. 국가 지원액은 공립유치원 월 2만 원, 사립유치원 월 11만 원, 어린이집 월 7만 원 수준이다. 유아 자녀를 둔 가정의 교육비 부담이 일부 완화될 전망이다.", "source": "대한민국 정책브리핑", "sourceUrl": "https://www.korea.kr/multi/visualNewsView.do?newsId=148958661", "image": "", "date": "2026-07-01" },
      { "category": "교육정책", "title": "3월부터 수업 중 스마트폰 사용 제한 법제화·고교학점제 전면 확대", "desc": "2026년 3월 신학기부터 수업 중 스마트폰 사용을 제한하는 규정이 법적으로 시행됐고, 고교학점제가 전 학년으로 확대됐다. AI 디지털교과서 적용 학년도 늘어나 초·중·고 교실 환경이 전반적으로 달라지고 있다.", "source": "대한민국 정책브리핑", "sourceUrl": "https://www.korea.kr/multi/visualNewsView.do?newsId=148958661", "image": "", "date": "2026-07-01" }
    ],
    "coach": [
