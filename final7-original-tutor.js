(function(root){
  ...
  var SCRIPTED_TUTORS={
    ...
    28:{title:'삼각 수 배열의 이웃 합',page:'007.jpg',view:'600 700 550 600',summary:'원 안의 수를 제외하고 변이 맞닿은 여섯 칸을 원 안의 수와의 차로 나타냅니다.',answer:'30',answerLabel:'원 안의 수',steps:[
      ...
      {title:'원 안의 수를 ○라 놓아요',speech:'○가 있는 줄을 r번째 줄이라 해 볼게요. 변이 맞닿은 여섯 수는 ○−r, ○−(r−1), ○−1, ○+1, ○+r, ○+(r+1)입니다.',deep:'같은 줄에서는 바로 앞뒤라 1 차이입니다. 위쪽 두 칸은 r과 r−1만큼 작고, 아래쪽 두 칸은 r과 r+1만큼 큽니다. 보기의 9는 r=4인 예일 뿐이에요.',visual:'<span>○−r</span><span>○−(r−1)</span><span>○−1</span><span>○+1</span><span>○+r</span><span>○+(r+1)</span>'},
      {title:'여섯 이웃의 합을 정리해요',speech:'○는 여섯 번이고, 줄 번호와 좌우 차이를 합치면 −r−(r−1)−1+1+r+(r+1)=2입니다. 그래서 6○+2=182예요.',deep:'r은 서로 지워집니다. 원 안의 ○ 자체는 더하지 않고, 변이 맞닿은 여섯 칸만 더한 식입니다.',visual:'<span>6○+2</span><i>=</i><span>182</span>'},
