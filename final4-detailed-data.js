(function(root){
  ...
  var ANSWER_BINDINGS=deepFreeze([
    ...
    {no:11,canonicalExact:'45',displayAnswerExact:'45'},
  ...
  var RAW_ITEMS=[
    ...
    {no:11,title:'잘못 본 자리 숫자를 바로잡아 뺄셈의 차 구하기',answer:'45',displayAnswer:'45',sourceLocator:'materials/final_4/002.jpg#q11',read:'빼어지는 수의 일의 자리 1을 7로, 빼는 수의 십의 자리 7을 1로 잘못 보고 계산한 차가 111입니다.',method:'앞 수와 빼는 수가 각각 얼마나 달라졌는지 확인하고, 잘못 계산한 차에서 늘어난 만큼을 뺍니다.',steps:[
      {title:'앞 수가 커진 만큼 찾기',body:'일의 자리 1을 7로 보았으므로 앞 수가 6 커졌습니다.'},
      {title:'빼는 수가 작아진 만큼 찾기',body:'십의 자리 7을 1로 보았으므로 빼는 수가 60 작아졌습니다. 따라서 뺄셈의 차는 60 더 커집니다.'},
      {title:'정확한 차 구하기',body:'잘못 계산한 차는 실제보다 6＋60＝66 큽니다. 정확한 차는 111－66＝45입니다.'}],check:'예를 들어 121－76＝45인데, 두 숫자를 잘못 보면 127－16＝111이 됩니다.',caution:'빼는 수가 작아지면 뺄셈의 차는 커집니다. 6과 60을 합쳐 잘못 계산한 차에서 빼야 합니다.'},
    ...
    {no:13,title:'색연필 수에 따른 풀의 수를 같은 양으로 맞추기',answer:'16개',displayAnswer:'16개',sourceLocator:'materials/final_4/003.jpg#q13',read:'색연필 8개를 놓으면 풀이 4개 더 필요하고, 색연필 2개를 놓으면 풀이 13개 더 필요합니다. 풀만으로 같은 가로 길이를 채울 때의 개수를 구합니다.',method:'두 줄에서 똑같이 놓인 색연필과 풀을 먼저 빼고, 남은 수를 같은 묶음으로 나누어 색연필을 풀로 바꿉니다.',steps:[
      {title:'양쪽에서 같은 것 빼기',body:'두 줄에서 색연필 2개와 풀 4개를 똑같이 빼 봅니다. 그러면 색연필 6개의 길이와 풀 9개의 길이가 같습니다.'},
      {title:'같은 묶음으로 나누기',body:'색연필 6개와 풀 9개를 각각 3묶음으로 나누면 색연필 2개의 길이는 풀 3개의 길이와 같습니다.'},
      {title:'색연필을 풀로 바꾸기',body:'색연필 8개는 색연필 2개씩 4묶음입니다. 한 묶음이 풀 3개와 같으므로 색연필 8개는 풀 12개와 같습니다. 처음부터 함께 있던 풀 4개를 더하면 12＋4＝16개입니다.'}],check:'다른 줄에서도 색연필 2개를 풀 3개로 바꾸면 3＋13＝16개로 같습니다.',caution:'양쪽에 똑같이 있는 것을 먼저 빼야 합니다. 풀 4개와 13개의 차인 9개를 바로 답으로 쓰지 않습니다.'},
    {no:14,title:'작년 세 사람의 나이 합과 18년 뒤 조건으로 내 나이 찾기',answer:'11살',displayAnswer:'11살',sourceLocator:'materials/final_4/003.jpg#q14',read:'현재 나와 동생의 나이 합은 할머니 나이의 1/4이고, 작년 세 사람의 합은 72살입니다. 18년 뒤 동생 나이는 현재 내 나이의 2배입니다.',method:'작년의 합을 올해의 합으로 바꾸고, 나와 동생의 합을 동그라미 한 묶음으로 나타낸 뒤 가능한 나이쌍을 차례로 확인합니다.',steps:[
      {title:'올해 세 사람의 합 구하기',body:'작년에서 올해가 되면서 세 사람이 모두 1살씩 늘었습니다. 올해 세 사람의 나이 합은 72＋3＝75살입니다.'},
      {title:'동그라미 묶음으로 두 아이의 합 구하기',body:'나와 동생의 나이 합을 동그라미 1개로 보면 할머니 나이는 동그라미 4개입니다. 모두 동그라미 5개가 75살이므로 한 동그라미는 75÷5＝15살입니다. 따라서 나와 동생의 나이 합은 15살이고 할머니는 60살입니다.'},
      {title:'가능한 나이쌍을 차례로 확인하기',body:'내가 동생보다 나이가 많으므로 두 나이의 합이 15가 되는 경우를 8살과 7살, 9살과 6살, 10살과 5살, 11살과 4살, 12살과 3살로 써 봅니다. 동생이 4살일 때 18년 후에는 22살이고, 이는 지금 내 나이 11살의 2배입니다. 따라서 나는 11살입니다.'}],check:'현재 나이는 나 11살, 동생 4살, 할머니 60살입니다. 작년 합은 10＋3＋59＝72이고, 18년 뒤 동생은 22살로 지금 내 나이의 2배입니다.',caution:'18년 후의 동생 나이와 지금 내 나이를 비교합니다. 나와 동생의 합 15살을 구한 뒤 가능한 두 나이를 직접 써서 확인합니다.'},
