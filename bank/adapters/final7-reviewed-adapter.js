...
(function (root, factory) {
  ...
  var edition = '2025';
  var types = [
    {id:'hidden-remainder-from-picture-count',domain:'number',middle:'뺄셈',label:'전체에서 그림 속 수와 따로 있는 수를 빼기',gradeBand:{from:'g2',to:'g4'},solvingModel:'total-minus-two-visible-groups',visualModel:'scattered-countable-objects',answerContract:'single-number',generatorId:'final7-q01',rendererId:'reviewed-raster',searchAliases:['흩어진 물건','전체와 부분','보이지 않는 수']},
    {id:'mirror-clock-elapsed-time',domain:'measurement',middle:'시각과 시간',label:'거울에 비친 시각을 고쳐 지난 시간 구하기',gradeBand:{from:'g2',to:'g4'},solvingModel:'mirror-time-reflection-then-elapsed',visualModel:'mirror-analog-clock',answerContract:'single-number',generatorId:'final7-q02',rendererId:'reviewed-raster',searchAliases:['거울 시계','시각과 시간','몇 분']},
    {id:'staircase-all-squares-count',domain:'geometry',middle:'도형 세기',label:'계단형 성냥개비 배열의 크고 작은 정사각형 세기',gradeBand:{from:'g3',to:'g5'},solvingModel:'count-axis-aligned-squares-by-size',visualModel:'odd-row-square-staircase',answerContract:'single-number',generatorId:'final7-q03',rendererId:'reviewed-raster',searchAliases:['성냥개비 정사각형','크고 작은 정사각형','도형 개수']},
    {id:'rectangle-symbol-complement-count',domain:'number',middle:'곱셈과 뺄셈',label:'직사각형 전체 자리에서 빈 자리를 빼어 도형 수 구하기',gradeBand:{from:'g2',to:'g4'},solvingModel:'rectangular-total-minus-missing',visualModel:'incomplete-symbol-rectangle',answerContract:'single-number',generatorId:'final7-q04',rendererId:'reviewed-raster',searchAliases:['별 배열','빈 자리','직사각형 배열']},
    ...
    {id:'double-chain-fourth-exceeds-rest',domain:'number',middle:'배수 관계와 합',label:'연속한 두 배 관계와 세 사람의 합보다 많은 수로 첫 사람의 수량 구하기',gradeBand:{from:'g3',to:'g5'},solvingModel:'multiplicative-chain-total-equation',visualModel:'text-only',answerContract:'single-number',generatorId:'final7-q25',rendererId:'text-block',searchAliases:['두 배 관계','네 사람 수량','세 사람의 합']},
  ...
  function load() {
    ...
    if (!loadPromise) loadPromise = fetch('data/final7-reviewed.json?v=13', {cache:'no-cache'}).then(function (response) {
