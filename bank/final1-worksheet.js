(function(global){
  ...
  function mount(opts){
    ...
    else if(!Array.isArray(ids))ids=wrong?[]:(round===7?Array.from({length:26},(_,i)=>idPrefix+String(i+5).padStart(2,'0')):Array.from({length:30},(_,i)=>idPrefix+String(i+1).padStart(2,'0')));
