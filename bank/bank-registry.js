...
(function (root, factory) {
  ...
  var REVIEWED_TAXONOMY_OVERRIDES = Object.freeze([
    ...
    eligibleTaxonomyOverride('final|2|18', '식의 계산', '포함과 배제(최대,최소)', '포함과 배제', 'exhaustive-partition-open-range-extrema', '전체를 네 가지 경우로 나누어 남은 수의 최솟값·최댓값 구하기', 'type-1yhugzn'),
    ...
    eligibleTaxonomyOverride('final|2|25', '수·규칙찾기', '성냥개비 도형의 개수', '규칙수열·도형배열', 'composite-figure-layer-sequence-triangle-count', '위쪽 띠와 아래쪽 삼각형의 규칙으로 작은 정삼각형 세기', 'type-0q6gg27'),
  ...
  /* 최종 7회는 원문 구조와 답을 검수한 고정 문항 3개씩을 연결한다. */
  [
    [1, '전체에서 그림 속 수와 따로 있는 수를 빼어 보이지 않는 수 구하기', true],
    [2, '거울에 비친 시각을 실제 시각으로 고쳐 지난 시간 구하기', true],
    [3, '계단형 성냥개비 배열에서 크고 작은 정사각형 세기', true],
    [4, '직사각형 전체 자리에서 빈 자리를 빼어 별의 수 구하기', true],
    ...
    [11, '마지막 큰 좌석을 따로 빼고 두 종류 좌석 수 구하기', false],
    [12, '정사각형을 반복 분할해 두 단계의 색칠 넓이 차 구하기', true],
  ...
  [
    ...
    [18, '전체를 네 가지 경우로 나누어 남은 수의 최댓값·최솟값', false],
