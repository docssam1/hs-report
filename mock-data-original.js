...
(function(){
  ...
  var round2 = [
    ...
    q(8, '도형', '선과 위치', '복잡한 교차점 세기', '7곳', 2.7, 'D4'),
    q(9, '수·규칙찾기', '간격·자르기', '그림에서 교점 수 발견', '29도막', 2.7, 'D3'),
    q(10, '도형', '연결과 영역', '미로형 경계의 양쪽 추적', '9마리', 2.7, 'D4'),
    ...
    q(23, '수·규칙찾기', '조건에 맞는 수', '디지털 칸 수', '9711', 4.2, 'D4'),
    q(24, '수·규칙찾기', '규칙수열·도형분할', '반복 분할선 길이', '126cm', 4.2, 'D4'),
    q(25, '식의 계산', '재치 있게 계산하기', '반복 숫자 덧셈', '23개', 4.2, 'D4'),
    q(26, '경우의 수', '최단거리', '금지 선분이 있는 경로', '64가지', 4.2, 'D4'),
    q(27, '식의 계산', '나이 계산', '서로 다른 시점의 두 쌍 합', '19살, 15살, 12살', 4.2, 'D4'),
    q(28, '도형', '쌓기나무', '세 방향 관통선의 합집합', '11개', 4.2, 'D5'),
    q(29, '도형', '도형의 개수', '불규칙 선망의 삼각형', '21개', 4.2, 'D4'),
    q(30, '도형', '공간지각', '평면 미로와 입체 시야', 'H1', 4.2, 'D5')
  ];
